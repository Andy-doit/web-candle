...
export default function StorySection() {
  ...
  return (
    <section className="bg-light  pt-5 md:pt-10">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-12 md:mb-16">
          ...
          <p className="text-dark max-w-2xl mx-auto text-sm md:text-base mt-4">
            Trang trí và thưởng thức nến là cả một nghệ thuật đòi hỏi sự tinh
            tế. Khi ngọn nến được thắp lên, thời gian như chậm lại, mang đến
            những khoảnh khắc bình yên và thanh thản cho tâm hồn.
          </p>
        </div>
